...
class DashboardController extends Controller
{
    public function dashboard()
    {
        ...
        return view('dashboard.dashboard', compact(['totalRevenue', 'totalnewOrders', 'totalRegisteredUsers', 'totalProducts', 'totalCategories', 'totalSalesPerMonth', 'months', 'sales']));
    }
