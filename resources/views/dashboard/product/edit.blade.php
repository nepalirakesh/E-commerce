    ...
    <div class="card">
        <form class="p-3 border" action="{{ route('product.update', $product) }}" method="POST"
            ...
            <div class="form-group">
                ...
                <input type="file" class="form-control" id="image" name="image" onchange="loadFile(event)" value={{
                    $product->image }}>
                <span style="color:red">
                    @error('image')
                    {{ $message }}
            ...
            <div class="form-group">
                ...
                <br>
                <img src={{ asset("storage/images/".$product->photo->front_image) }} width="100px" height="100px"
                alt="">
            ...
            <div class="form-group">
                ...
                <br>
                <img src={{ asset("storage/images/".$product->photo->side_image) }} width="100px" height="100px"
                alt="">
            ...
            <div class="form-group">
                ...
                <br>
                <img src={{ asset("storage/images/".$product->photo->back_image) }} width="100px" height="100px"
                alt="">
                ...
                <div class="spec">
                    <div class="row">
                        <div class="form-group col-5">
                            <input type="text" class="form-control" name="specifications[{{ $key }}][specification]"
                                placeholder="Enter specification" value="{{ $value['specification'] }}">

                        </div>
                        <div class="form-group col-6">
                            <input type="text" class="form-control" name="specifications[{{ $key }}][value]"
                ...
                <div class="spec">
                    <div class="row">
                        ...
                        <div class="form-group col-sm-6">
                            <input type="text" class="form-control" name="specifications[{{ $spec->id }}][value]"
                                value="{{ $spec->value }}">
                        </div>
                        <div class="col-sm-1">
                            <a class="btn btn-danger delete_button"><i class="fa fa-trash" aria-hidden="true"></i>
                            </a>
                        </div>
                    </div>
                </div>
